...
def DrawHydro(PresentTimeTxt, ConvQ2H, HomeDir, Hydro_f_type, Hydro_f, Hydro_locNo, RsltDir, ObsData, \
    ...
    ax1.legend(prop=fp, facecolor='white', framealpha=1, edgecolor='black', loc='upper right', bbox_to_anchor=(1, 0.90))
    #ax2.legend()
...
if __name__ == "__main__":
    ...
    HOME_DIR   = r"C:\Users\bikra\Desktop\DA_PF_RRI\with_DA\Daily\Metrics\2022\N1_wl_2022"           # has PythonCode/DrawingConfig.ini
    ...
    START_TS   = "202207190000"  # inclusive; format YYYYMMDDHHMM
    END_TS     = "202209200000"  # inclusive
    ...
    OUT_DIR    = os.path.join(HOME_DIR, "Results/Drawing_DA")
    # =====================================
