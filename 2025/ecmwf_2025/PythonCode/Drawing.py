...
def DrawHydro(PresentTimeTxt, ConvQ2H, HomeDir, Hydro_f_type, Hydro_f, Hydro_locNo, RsltDir, ObsData, \
    ...
    if AllParticleFlg == 1:
        ...
        for iPn in range(Pn):
            ...
            ax1.plot(ls_AllHydroDatetime, ls_iPnHydroData,lw=1.0, alpha=0.5, linestyle="solid", color='orange',
             label='ECMWF All Particle W.L' if iPn == 0 else "")
    ...
    if ForecastHyd_BestP_Flg != 0:
        ...
        ax1.plot(ls_Datetime_HydBestP, ls_Hydro4Fig,lw=1.5,alpha=1.0,label='ECMWF Best Particle W.L',linestyle="dotted",markersize=3,color='blue')
    #########Forecasted wl/qr for BestP ##################################
    ...
    if ForecastHyd_OrgP_Flg != 0:
        ...
        if ForecastHyd_OrgP_Flg == 2:
            ...
            NowErrVal = NowObsVal - NowCalcVal
            ls_Hydro4Fig = ls_Hydro4Fig + NowErrVal
        ax1.plot(ls_Datetime_HydOrgP, ls_Hydro4Fig,lw=1.5,alpha=1.0,label='ECMWF Original Particle W.L',linestyle="dashed",markersize=3,color='Red')
    #########Forecasted wl/qr for OrgP ##################################
    ...
    if ForecastHyd_WtMean_Flg != 0:
        ...
        if ForecastHyd_WtMean_Flg == 2:
            ...
            NowErrVal = NowObsVal - NowCalcVal
            ls_Hydro4Fig = ls_Hydro4Fig + NowErrVal
        ax1.plot(ls_Datetime_HydWtMean, ls_Hydro4Fig,lw=1.5,alpha=1.0,label='ECMWF Mean Particle W.L',linestyle="solid",markersize=5,color='Red')
    #########Forecasted wl/qr for weight mean ##################################
